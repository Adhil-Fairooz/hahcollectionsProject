...
session_start();
if(isset($_GET['pid']) && $_REQUEST['task'] ==='customer'){
...
?>
<?php 
if(isset($_GET['pId']) && $_REQUEST['task']='homepage'){
    $productResults = $productObj->getProductInfomation($_GET['pId']);
    $ratingResults = $productObj->getRatingValue($_GET['pId']);
    $rateValue = 0;
    $FinalRateValue = 0;
            ...
            <div class="container my-modal-container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-12 ">
                        ...
                        <input type="hidden" name="productId" value="<?=$_GET['pId']?>">
                        <!--Add to cart Button-->
                        <a name="addToCart"  class="btn btn-primary" id="addtoCart" href="login.php" ><i class="fas fa-cart-plus fa-lg"></i> Add to cart</a>
                        <button type="button" class="btn btn-danger disabled" id ="stockOut"><i class="far fa-times-circle"></i> Stock Out</button> 
                        <!--Add to cart Button end-->                 
                    </div>
                </div>
